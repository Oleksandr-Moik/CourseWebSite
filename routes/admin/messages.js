...
router.get('/', async (req, res, next) => {
    try{
        ...
        res.render('admin', {model:'message', data: {users, messages}, action:'list'})
    }catch (e){
        next(e)
    }
});
...
router.get('/edit/:id', async (req, res, next) => {
    try{
        ...
        res.render('admin', {model:'message', data:{users, statuses, msg: {...message}}, action: "edit"})
    }catch (e){
        next(e)
    }
});
...
router.get('/delete/:id', async (req, res, next) => {
    try{
        ...
        res.render('admin', {model:'message', data, action: "delete"})
    }catch (e){
        next(e)
    }
})
