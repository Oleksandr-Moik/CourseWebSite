...
router.get('/create', async (req,res,next)=>{
    try{
        ...
        res.render('admin',{model:'lesson', data:{statuses, themes, users}, action:'create'})
    }catch (e){
        next(e)
    }
});
...
router.get('/edit/:id', async (req, res, next) => {
    try{
        ...
        res.render('admin', {model:'lesson', data, action: "edit"})
    }catch (e){
        next(e)
    }
});
...
router.get('/delete/:id', async (req, res, next) => {
    try{
        ...
        res.render('admin', {model:'lesson', data, action: "delete"})
    }catch (e){
        next(e)
    }
})
